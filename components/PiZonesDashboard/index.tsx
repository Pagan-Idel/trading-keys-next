...
export default function PiZonesDashboard(){
  ...
  const scenario=useMemo(()=>snapshot?{candles,timeframe,isLiveAutomation:true,leg,swings,zones:snapshot.zones,zoneEvidence:focusedZoneEvidence,tradeSetup,tradeSetups}:undefined,[candles,focusedZoneEvidence,leg,snapshot,swings,timeframe,tradeSetup,tradeSetups]);

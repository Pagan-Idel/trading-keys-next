      ...
      >
        <div style={{ width: 'min(1420px, calc(100% - 32px))', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, margin: '18px auto 26px' }}>
          ...
          <nav style={{ display: 'flex', gap: 8, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
            ...
            <Link href="/research" prefetch={false} style={{ color: '#83f4ff', textDecoration: 'none', border: '1px solid #28616a', background: '#10272b', borderRadius: 10, padding: '8px 12px', fontSize: 13 }}>Research</Link>
          </nav>
        </div>
